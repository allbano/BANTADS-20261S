...
export class CrudGerentes {
  gerentes: Gerente[] = [
    { id: 1, nome: 'Ana Souza', email: 'ana.souza@bantads.com', cpf: '111.222.333-44', clientes: 45 },
    { id: 2, nome: 'Carlos Silva', email: 'carlos.silva@bantads.com', cpf: '555.666.777-88', clientes: 32 },
    { id: 3, nome: 'Beatriz Lima', email: 'beatriz.lima@bantads.com', cpf: '999.888.777-66', clientes: 12 }
  ];
